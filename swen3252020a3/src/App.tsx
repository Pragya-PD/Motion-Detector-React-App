  ...
  <IonApp>
    <IonReactRouter>
        <IonRouterOutlet>
          ...
          <Route path="/checkbatterylevels" component={CheckBatteryLevels} exact={true}/>
          <Route path="/trackmovements" component={TrackMovements} exact={true}/>
          <Route path="/managerooms" component={ManageRooms} exact={true}/>
          <Route path="/" render={() => <Redirect to="/connectToIoT" />} exact={true} />
        </IonRouterOutlet>
    </IonReactRouter>
  </IonApp>
);
